      ...
      <main className="flex-1">
        {activeTab === 0 && (
          <div className="flex flex-col items-center justify-center gap-6 py-12">
            ...
            {/* aviso beta: explica el método de apertura manual sin ensuciar el hero */}
            <div className="flex w-full max-w-md flex-col gap-2 border border-border bg-primary/[0.03] px-4 py-3 text-left text-xs leading-relaxed text-text-muted">
              <span className="flex items-center gap-2">
                ...
                <span>app sin firmar todavía. la primera vez en macOS ábrela con:</span>
              </span>
              <code className="select-all bg-primary/[0.08] px-2 py-1.5 text-primary">
                xattr -cr /Applications/obsee.app
              </code>
              <span className="text-text-faint">o clic derecho › abrir. solo hace falta una vez.</span>
            </div>
